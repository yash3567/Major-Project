...
//                   alt="Project Image"
//                   className="w-full md:w-[400px] h-[270px] object-cover rounded-lg border border-gray-400"
//                 />
//               ) : (
//                 <div className="w-full md:w-96 h-52 flex items-center justify-center border border-gray-400 rounded-lg bg-gray-100">
...
//                 {projectdetails.link ? (
//                   <Link to={projectdetails.link} target="_blank" rel="noopener noreferrer">     {/* ---------> this link open in another tab */}
//                     <button className="bg-blue-600 text-white px-4 py-2 rounded-lg shadow hover:bg-blue-700 w-full md:w-auto">
//                       Visit Project
//                     </button>
//                   </Link>

//                   // <Link to={projectdetails.link}>  {/* ---------> this link open in similar tab */}
...
//                 ) : (
//                   <button className="bg-gray-400 text-white px-4 py-2 rounded-lg shadow cursor-not-allowed w-full md:w-auto" disabled>
...
//                 {isZipFile ? (
//                   <button
//                     className="bg-green-600 text-white px-4 py-2 rounded-lg shadow hover:bg-green-700 w-full md:w-auto"
...
const ProjectDetails = () => {
  ...
  const [showBuyModal, setShowBuyModal] = useState(false);
  const upiLink = `upi://pay?pa=vipinjugnake@okicici&pn=SellerName&am=${projectdetails?.price}&cu=INR`;
  ...
  const isZipFile =
    projectdetails?.projectfile?.filename?.endsWith(".zip") || false;
            ...
            <div className="flex justify-center items-center">
              {projectdetails.projectImage ? (
                <img
                  src={projectdetails.projectImage}
                  alt="Project Image"
                  className="h-60 w-100 object-cover rounded-lg border border-gray-400"
                  style={{ height: "270px" }}
                />
              ) : (
