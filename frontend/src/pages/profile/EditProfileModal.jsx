...
const EditProfileModal = ({ authUser }) => {
	...
	// Load existing user data when the modal opens
	useEffect(() => {
		if (authUser) {
			setFormData({
				...
				bio: authUser.bio,
				links: authUser.links && authUser.links.length > 0
					? [...authUser.links.slice(0, 3), ...Array(3 - authUser.links.length).fill("")]
					: ["", "", ""], // Ensure always 3 links
				newPassword: "",
				currentPassword: "",
			});
		}
